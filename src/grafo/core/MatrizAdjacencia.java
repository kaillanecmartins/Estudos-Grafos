...
public class MatrizAdjacencia {
    ...
    public int getPeso(int indiceVerticeInicial, int indiceVerticeFinal){
    ...
    public void copiaValoresPara(MatrizAdjacencia matrizDestino) throws Exception {
        if (matrizDestino.getQtdVertices() < this.qtdVertices) {
            throw new Exception(
                "Somente é possível executar cópias em matrizes com dimensões iguais " + 
